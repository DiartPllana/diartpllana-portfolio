          ...
          <div className="resumeData">
            ...
            <div className="eduactionDateInfo">
              ...
              <div className="infoAboutEducation">
                ...
                <p>
                  Innovation Academy in Vushtrri, established in 2019, focuses
                  on developing technological skills and problem-solving
                  abilities among students from a young age. The academy
                  emphasizes creativity and innovation, encouraging students to
                  work on real-life projects, such as those showcased at events
                  like "Vushtrri Code Fest".
                </p>
              </div>
            </div>
            <div className="eduactionDateInfo">
              ...
              <div className="infoAboutEducation">
                <h3>Udemy</h3>
                <p>
                  Udemy is an online learning platform that offers a wide range
                  of courses across various subjects, enabling individuals to
                  learn at their own pace. It serves as a marketplace for
                  instructors to create and share courses, making education more
